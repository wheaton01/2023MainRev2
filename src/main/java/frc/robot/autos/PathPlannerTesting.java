...
public class PathPlannerTesting extends SequentialCommandGroup {
    String trajectoryJSON = "src/main/deploy/pathplanner/NewPath.path";//"src/main/deploy/output/test11823.wpilib.json"; //"./src/main/deploy/output/test11823.wpilib.json";
    ...
    public PathPlannerTesting(Swerve s_Swerve){//, Limelight lime
